...
use Acme\DemoBundle\Form\DocumentType;
...
class DocumentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeDemoBundle:Document')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeDemoBundle:Document:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('document_show', array('UploadDir'=>$entity->getUploadDir(),'id' => $entity->getId())));
     ...
     * @Method("PUT")
     * @Template("AcmeDemoBundle:Document:edit.html.twig")
     */
